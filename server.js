...
const MENU_REGISTRY = [
    ...
    { key:'terminal_settings_view', label:'POS Terminal — Open the "Settings" Modal From the Terminal Page (Desktop View, Mirrored Subset of Store/Appearance/Advanced Settings)', group:'Settings' },
    ...
    { key:'relay_unlock_request', label:'Features/Themes — Can Send Unlock/Demo OTP Request to Relay', group:'Features & Themes' },
    { key:'cloud_tokens_view', label:'Omni Tokens / Cloud Backup Billing — View-Only (Balance, Transaction History; Does Not Include Buying Tokens or Auto-Sync Toggle — Admin Only)', group:'Settings' },
];
